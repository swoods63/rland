...
<h2><strong>PROPERTY RIGHTS, HISTORICAL CONTEXT</strong></h2>
    ...
    <li>
     What does it mean when you say “all mineral rights are reserved ”?
      <h4 class="answer">
      The minerals above or below the surface are reserved to the Government, Mining Company, Prospector or a private individual.<br><br>
      This includes all precious metals, ores, sand & gravel. When a Mining Company, Prospector or other individual own the mineral rights, they do not need the owners permission to go on the property and do exploration work. The Mining Company, Prospector or other individual only need to inform you in writing, the day before, of their intent to perform work.<br><br>
      Owning the timber rights on the property, when the mineral rights are reserved, is a very large plus for the property owner.<br><br>
      The majority of prospectors and mining companies are very good to work with, and between the owner and themselves, will normally work out a fair compensation package for any exploration work that will be performed.<br><br>
      All private properties that were patent under the Private Lands Act prior to 1913, have the mineral rights included in the property<br><br>
...
<h2><strong>ENTERING CANADA</strong></h2>
    ...
    <li>
      ...
      extended hours of service for travellers arriving at designated remote customs offices (available at two sites only: Forest City and Fosterville, New Brunswick).<br><br>
    ...
    <li>
      ...
      <h4 class="answer">
      You may bring a hunting rifle or shotgun and up to 200 rounds of ammunition into Ontario as a visitor, but you must be 18 years of age or older to do so and the firearms must be for hunting or competitions use. You must be at least 18 years of age to bring firearms into Canada.<br><br>
      You must either have a Canadian Possession and Acquisition License (PAL) or you have to register your firearms at the Canadian border. You are able to complete pre-registration forms before you cross the border which will make it easier and less time consuming. The permit fee is $50.00 (Cdn) per person for a temporary registration permit and the permit is valid for 12 months. Call toll-free 1-800-731-4000 to get a Firearms Declaration Form. Easiest way to obtain a Canadian PAL (possession and Acquisition License) prior to importing guns into Canada. If you have a PAL, you do not have to fill out registration forms and there is only a one time fee.<br><br>
      You cannot import prohibited firearms. Fully automatic weapons, all hand guns and guns of less than 66 cm (26 inches) in length are prohibited by law.<br><br>
      Restricted firearms such as pistols or revolvers may be temporarily imported if you have an Authorization to Transport (ATT) in advance from a Canadian Chief Firearms Officer.<br><br>
      Seasonal residents may import restricted firearms, but must have a Possession and Acquisition License or a valid Firearms Acquisition Certificate in addition to an ATT.<br><br>
    ...
    <li>
      What should I know before entering into Canada?
      <h4 class="answer">
      The Canada / US border is reputed to be the friendliest border in the world. Here are some tips to help make your crossing quick and easy:<br><br>
      <b class="b">Identification</b><br>
      US Citizens and legal residents of the United States do not need passports or visas to enter Canada as visitors. You should however carry some identification such as birth, voter's or naturalization certificate which shows your citizenship.<br><br>
      <b class="b">Children</b><br>
      Canada Customs and Immigration officers are members of Child Find International. Anyone travelling with children not their own may be required to show written permission from the child's parent(s) and proper identification (birth certificate).<br><br>
      <b class="b">Other Countries</b><br>
      Visitors from countries other than the US require a valid passport and in some cases a visitor's visa. Visas are issued by Canadian Immigration offices, embassies and consulates.<br><br>
      <b class="b" >Making Declarations</b><br>
      Canadian Customs officials will ask your place of residence (country and city) the purpose of your visit to Canada, how long you intend to stay, and if you have anything to declare. You may be asked specifically if you are bringing alcohol, tobacco, fruit, vegetables, animals or items made from animal by-products, firearms or personal protection devices into Canada.<br><br>
      Gifts up to $60 (Canadian funds) each in value are duty free provided they do not contain alcohol, tobacco or advertising material.<br><br>
      As long as you meet the age requirement set by the province where you enter Canada (19 in Ontario), you may import 1.5 litres of wine or 1.14 litres (40 ounces) of liquor OR 24 x 355 ml cans or bottles of beer or ale. Those over 18 years of age may bring 200 cigarettes, 50 cigars, 200 grams of manufactured tobacco and 200 tobacco sticks.<br><br>
      <b class="b">Pets</b><br>
      Dogs and cats accompanying their owners from the U.S. must have current (within 36 months) rabies vaccination certificates. Owners from other countries who wish to bring their pets should contact the nearest Canadian consulate or embassy.<br><br>
      <b class="b">Boaters</b><br>
      ...
      <b class="b">Criminal Records</b><br>
      Individuals with criminal records wishing to enter Canada can apply for a waiver. This should be done 3 - 4 weeks in advance of the intended visit. It should be noted that Driving Under the Influence convictions are considered a criminal offense in Canada. Individuals with criminal records without waivers can be refused entry. Contact the nearest port of entry Canada Immigration office for more information.<br><br>
      <b class="b">Your Dollar Goes Farther</b><br>
      US dollars and several foreign currencies enjoy a premium rate of exchange in Canada.<br><br>
      <b class="b">Goods and Services Tax (GST)</b><br>
      As a visitor to Canada you can claim a refund of 7% on every dollar spent while in the country on accommodation and most goods you take home.<br><br>
      </h4>
      <hr class="hr">
    </li>
  </ol>
...
Phone (807) 683-9871 and ask for:<br><br>

Elio Scocchia, Broker
Ph: 807.624.7977
elio@recreationland.net<br><br>
